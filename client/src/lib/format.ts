...
export const PERTURBATION_LABELS: Record<string, string> = {
  ...
  jpeg: "JPEG",
  jpeg_ai: "JPEG AI",
  jpeg_recompression_comb_jpegai: "JPEG + JPEG AI recompress",
  lensblur: "Lens blur",
  wmforger: "WMForger",
  brighten: "Brighten",
  clahe: "CLAHE",
  ...
  randomaspectcrop: "Random aspect crop",
  randomcrop: "Random crop",
  randomtonecurve: "Tone curve",
  rgbshift: "RGB shift",
  adv_embed_clip: "Adversarial embed (CLIP)",
  adv_embed_resnet: "Adversarial embed (ResNet)",
};
